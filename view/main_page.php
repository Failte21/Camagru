...
<main class="centerContainer" id="mainPage">
  <section id="videoCanvas">
    <div id="videoContainer">
      <video poster="/camagru2/img/some_guy.jpg"></video>
      <img src="/camagru2/img/frames/banana.png" alt="" />
    ...
    <div id="frameSelect">
      ...
      <label class="radio-img">
        <input type="radio" name="img"  class="frame_radio"  class="frame_radio" value="mustache">
        <div class="imgContainer">
          <img src="/camagru2/img/icons/mustache2.png">
        </div>
      </label>
      <label class="radio-img">
        <input type="radio" name="img"  class="frame_radio" value="mustache2">
        <div class="imgContainer">
          <img src="/camagru2/img/icons/baseballHat.png">
        </div>
      </label>
      <label class="radio-img">
        <input type="radio" name="img"  class="frame_radio" value="mustache2">
  ...
  <section id="previewCanvas">
    <img src="/camagru2/img/rfoquet2.jpg" alt="" />
    <img src="/camagru2/img/rfoquet2.jpg" alt="" />
    <img src="/camagru2/img/rfoquet2.jpg" alt="" />
  </section>
</main>
